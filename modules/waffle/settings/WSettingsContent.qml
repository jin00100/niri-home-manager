...
Item {
    ...
    property var searchIndex: [
        ...
        { pageIndex: 4, pageName: "Themes", section: "Cava Options", label: "Cava palette, response and apps", targetLabel: "Color source", keywords: ["cava", "visualizer", "spectrum", "audio", "source", "apps", "spotify", "ncspot", "palette", "vibrant", "album", "cover", "sensitivity", "bars", "framerate", "stereo", "wave", "opacity", "reset"] },
        ...
        { pageIndex: 7, pageName: "Modules", section: "Sidebars", label: "Arrange sidebar tabs", targetLabel: "Sidebars", keywords: ["sidebar", "left", "arrange", "order", "tabs", "drag"] },
        ...
        { pageIndex: 7, pageName: "Modules", section: "Material Modules in Waffle", label: "Left Sidebar", targetLabel: "Left Sidebar", keywords: ["sidebar", "left"] },
