...
Singleton {
    ...
    readonly property var defaultCategories: [
        ...
        { label: Translation.tr("Appearance"), pages: [4, 24, 3, 14, 20] },
        { label: Translation.tr("Shell"), pages: [2, 25, 5, 21, 22, 16, 10, 11, 18, 19] },
        { label: Translation.tr("System"), pages: [1, 23, 7, 6, 12, 15, 8, 17] },
    ...
    function searchIndex(): var {
        ...
        },
        {
            ...
            keywords: ["filter", "filters", "app", "apps", "notification", "mute", "block", "visualizer", "cava", "audio", "spotify", "ncspot", "discord", "slack"]
        },
                                                {
        ...
        },
        {
            ...
            keywords: ["spectrum", "audio", "cava", "bars", "wave", "origin", "bottom", "top", "center", "mirror", "ribbon", "density", "gap", "smoothing", "edge", "curve", "headroom", "profile", "accent", "bass", "warm", "vocal", "treble", "smile", "pill", "wings", "full screen", "bleed", "underlap"]
        },
        {
            pageIndex: 2, pageName: root.pages[2].name,
        ...
        },
        {
            ...
            keywords: ["sidebar", "left", "arrange", "order", "tabs", "drag", "widgets"]
        },
        {
            pageIndex: 20, pageName: root.pages[20].name,
            section: Translation.tr("Island surfaces"),
        ...
        { pageIndex: 23, pageName: root.pages[23].name, section: Translation.tr("Blur and glass"), label: Translation.tr("Default blur backend"), description: Translation.tr("Let the style choose, use wallpaper glass, compositor blur, or disable blur"), keywords: ["effects", "blur", "backend", "wallpaper", "compositor", "style", "glass"] },
        { pageIndex: 23, pageName: root.pages[23].name, section: Translation.tr("Per-area overrides"), label: Translation.tr("Bars, dock, panels, islands and widgets"), description: Translation.tr("Override the blur backend independently for each shell area"), keywords: ["effects", "area", "bar", "dock", "panel", "island", "ricelin", "widget"] },
        { pageIndex: 23, pageName: root.pages[23].name, section: Translation.tr("Motion and power"), label: Translation.tr("Reduce animations"), description: Translation.tr("Use immediate reduced-motion state changes"), keywords: ["motion", "animation", "reduce", "accessibility", "performance"] }
        ]
        return _staticSearchIndex
    }
}
